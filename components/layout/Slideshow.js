...
const Slideshow = () => {
  const images = [
    ...
    "https://images.unsplash.com/photo-1462396240927-52058a6a84ec?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=773&q=80",
    ...
    "https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    "https://images.unsplash.com/photo-1516501312919-d0cb0b7b60b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1304&q=80",
  ];
    ...
    <div>
      <Slider {...settings}>
        {images?.map((each, index) => (
          <div key={index} className="flex justify-center w-full h-[500px]">
            <img
              src={each}
              alt={""}
              className="object-cover shadow-xl mx-auto h-full"
            />
          </div>
        ))}
      </Slider>
